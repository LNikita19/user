...
const Navbar = () => {
    ...
    return (
        ...
        //     {/* Main Text */}
        //     <div className="relative flex flex-col items-center justify-center h-full text-center text-white space-y-4 px-5 pt-32 select-none z-10 leading-[0.2]">
        ...
        //             src="/person.webp"
        //             alt="Person"
        //             className="w-[60%] md:w-[45%] lg:w-[35%] max-w-[600px]"
        //         />
        //     </div>
